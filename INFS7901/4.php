...
<div class="navbar">
  ...
  <a class = "active" href="https://127.0.0.1/INFS7901/admin.php">back</a>
</div>
        ...
        <?php
         ...
         <table class="table">
           ...
           <tbody id="orderTable">
             ...
             $query = "SELECT ord.OrderStatus,AVG(dish.Price) as avg_price from restaurant as rest inner join orders as ord on
             rest.Rid = ord.Rid inner join dish as dish on dish.Rid = rest.Rid
             GROUP BY ord.OrderStatus";
             $result = mysqli_query($conn, $query);
             // put all our results into a html table
             while ($rows = mysqli_fetch_array($result)) {
                 echo "<tr>";
                 echo "<td>".$rows["OrderStatus"]."</td>";
                 echo "<td>".$rows["avg_price"]."</td>";
                 echo "</tr>";
               }
                 ?>
             </tbody>
