    ...
    <div class="main">
      ...
      if($_SERVER["REQUEST_METHOD"] == "POST"){
          ...
          if(empty($mail_err) && empty($password_err)){
              ...
              $sql = "SELECT Email, Pass FROM customerdetails WHERE Email = ?";
              ...
              if($stmt = mysqli_prepare($link, $sql)){
                  ...
                  if(mysqli_stmt_execute($stmt)){
                      ...
                      if(mysqli_stmt_num_rows($stmt) == 1){
                          ...
                          mysqli_stmt_bind_result($stmt, $mail, $password);
                          if(mysqli_stmt_fetch($stmt)){
                              if(password_verify($password,$password)){
                                  ...
                                  header("location: WelcomeCus.php");
                              } else{
...
<body>
    <div class="wrapper">
        ...
        <p>Please note this login is for customers only.</p>
        <a href="https://127.0.0.1/INFS7901/login1.php"><p>Are you a restaurant dealer? Click here!</p></a>
        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
            ...
            <p>New user? <a href="CustomerReg.php">Register here!</a></p>
        </form>
    </div>
  </div>
</div>
