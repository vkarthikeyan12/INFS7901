...
<div class="navbar">
  ...
  <a class = "active" href="https://127.0.0.1/INFS7901/rider.php">Rider</a>
</div>

<div class="row">
    <div class="main">
      <p>Hello Rider!. Here are List of order details for you:</p>
      <div class="vertical-menu">
        <a href="#" class="active">View from choices below</a>
        <?php
         ...
         <table class="table">
           ...
           <tbody id="orderTable">
             ...
             $query = "SELECT orders.Oid, orders.OrderStatus, orders.PaymentType, CustomerInfo.Address, RestaurantInfo.Address FROM orders, CustomerInfo, RestaurantInfo WHERE Orders.Cid = CustomerInfo.Cid AND Orders.Rid = RestaurantInfo.Rid;";
