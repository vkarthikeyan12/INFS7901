         ...
         <table class="table">
           <thead>
                 <tr>
                     ...
                     <th scope="col">Time Reference</th>
                 </tr>
             </thead>
           <tbody id="orderTable">
             ...
             $query = "SELECT ord.Oid,ord.Cid,ord.Rid,ord.OrderTime,ord.OrderStatus,ord.CompletionTime,ord.PaymentType,ord.PaymentType,ord.T1 from restaurant as rest inner join orders as ord on rest.Rid = ord.Rid where (`Type` LIKE '%".$type."%')";
             ...
             while ($rows = mysqli_fetch_array($result)) {
                 ...
                 echo "<td>".$rows["CompletionTime"]."</td>";
