...
if($_SERVER["REQUEST_METHOD"] == "POST"){
      ...
      if (empty(trim($_POST["name"] ||  $_POST["type"] || $_POST["mobile"]  )))
      {
    ...
    if(empty($blank)){
        ...
        $sql = "INSERT INTO restaurant (Name, Mobile, Type) VALUES (?, ?, ?)";

        if($stmt = mysqli_prepare($link, $sql)){
            // Bind variables to the prepared statement as parameters
            mysqli_stmt_bind_param($stmt, "sss", $_POST["name"], $_POST["mobile"], $_POST["type"]);
