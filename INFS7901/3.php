        ...
        <?php
         ...
         <table class="table">
           ...
           <tbody id="orderTable">
             ...
             $query = "SELECT SUM(dish.Price) as total_price from restaurant as rest inner join orders as ord on rest.Rid = ord.Rid inner join dish as dish on dish.Rid = rest.Rid where ord.OrderStatus = 'Complete';";
